...
public class homepage_pharma {
	...
	// private By menu =
	// By.id("com.android.systemui:id/miui_keyguard_vertical_clock");
	// private By menu =
	// By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.widget.TextView");
	...
	private By All = By.xpath("//android.view.View[@index='0']");
	private By All_text = By.xpath("//android.widget.TextView[@text='View all']");
	...
	public void click_on_all() {
		...
		List<MobileElement>ss= driver.findElements(All);
		System.out.println("size of the element "+ ss.size());
		ss.get(14).click();
//		 
	}
	
	public void verify_all_feature_is_open() {
		 String ss= driver.findElement(All_text).getText();
		 Assert.assertEquals("View all", ss);
	}
